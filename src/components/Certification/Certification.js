            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col text-center w-full mb-20">
                        <h2 className="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Be 'Melody Music Certified' Musician</h2>
                    ...
                    <div className="flex flex-wrap">
                        ...
                        <div className="xl:w-1/4 lg:w-1/2 md:w-full px-8 py-6 border-l-2 border-gray-200 border-opacity-60">
                            ...
                            <p className="leading-relaxed text-base mb-4">We arrange a number of Trainning Sessions over the time on different topics . Most of them are internationally Accrediated. </p>
                            <NavLink to={`/course/id`}>
                                <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Learn More</button>
                            </NavLink>
                        </div>
